...
boot_timeout_seconds = Integer(cfg_str.call('KUBE_BOOT_TIMEOUT_SECONDS', %w[tuning boot_timeout_seconds], '900'))
...
Vagrant.configure('2') do |config|
  ...
  config.vm.boot_timeout = boot_timeout_seconds
  config.vm.box = box
